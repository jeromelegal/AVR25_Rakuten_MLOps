...
class Settings(BaseSettings):
    ...
    MLFLOW_IMAGE_CLASSIFIER_MODEL_NAME: str = os.getenv(
        ...
        default="MLFLOW_IMAGE_CLASSIFIER_MODEL_NAME",
    )
    MLFLOW_IMAGE_CLASSIFIER_MODEL_VERSION: int = (
        int(os.getenv("MLFLOW_IMAGE_CLASSIFIER_MODEL_VERSION"))
        if os.getenv("MLFLOW_IMAGE_CLASSIFIER_MODEL_VERSION")
        else DEFAULT_MLFLOW_IMAGE_CLASSIFIER_MODEL_VERSION
    )
