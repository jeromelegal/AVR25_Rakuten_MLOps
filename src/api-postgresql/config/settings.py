...
class Settings(BaseSettings):
    ...
    ALGORITHM: str = os.getenv("API_POSTGRESQL_ALGORITHM", "")
    ACCESS_TOKEN_EXPIRE_MINUTES: int = int(os.getenv("API_POSTGRESQL_ACCESS_TOKEN_EXPIRE_MINUTES", 30))  # Valeur par défaut de 30 minutes
