...
su - postgresql -c "/usr/lib/postgresql/18/bin/initdb -D /data/postgresql"
...
su - postgresql -c "/usr/lib/postgresql/18/bin/postgres -D /data/postgresql -c config_file=/etc/postgresql/postgresql.conf" &
PID_POSTGRESQL=$!
...
# Arrêter PostgreSQL
su - postgresql -c "/usr/lib/postgresql/18/bin/pg_ctl -D /data/postgresql -l /data/postgresql/pg_log/logfile stop"
