...
http {
    server {
        ...
        location / {
            ...
            proxy_ssl_certificate     $API_TEXT_PROCESSING_CERT_PATH;
            proxy_ssl_certificate_key $API_TEXT_PROCESSING_KEY_PATH;
            proxy_ssl_trusted_certificate $API_TEXT_PROCESSING_CA_PATH;
            proxy_ssl_verify on;
