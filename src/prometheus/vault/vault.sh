...
mkdir -p $(dirname $PROMETHEUS_PEM_PATH) $(dirname $PROMETHEUS_CA_PATH) $(dirname $MINIO_PROMETHEUS_PEM_PATH) $(dirname $MINIO_PROMETHEUS_CA_PATH)
...
cat <<EOF > $MINIO_PROMETHEUS_PEM_PATH
$(printf "%s" "$MINIO_PROMETHEUS_KEY")
$(printf "%s" "$MINIO_PROMETHEUS_CERT")
EOF
